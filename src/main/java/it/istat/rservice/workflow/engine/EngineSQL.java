...
public  class EngineSQL implements EngineService {
	...
	/* (non-Javadoc)
	 * @see it.istat.rservice.workflow.engine.EngineService#init(it.istat.rservice.app.domain.Elaborazione, it.istat.rservice.workflow.domain.SxStepInstance)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see it.istat.rservice.workflow.engine.EngineService#eseguiStringaIstruzione()
	 */
	@Override
