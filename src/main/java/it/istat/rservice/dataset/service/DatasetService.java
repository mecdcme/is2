...
public class DatasetService {
    ...
    public DatasetFile salva(HashMap<String, ArrayList<String>> campi, HashMap<Integer, String> valoriHeaderNum,String separatore, String desc, String idsessione) throws Exception {
