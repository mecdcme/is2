...
public class WorkflowController {
    ...
    public String homeWS(HttpSession session, Model model, @PathVariable("id") Long id) {
        ...
        HashMap<Long, List<String>> paramsMissing=workflowService.findMissingAppRoleySubProcessAndTipoVar(elaborazione, new SxTipoVar(IS2Const.WORKSET_TIPO_PARAMETRO)); 
        HashMap<Long, List<String>> variablesMissing=workflowService.findMissingAppRoleySubProcessAndTipoVar(elaborazione, new SxTipoVar(IS2Const.WORKSET_TIPO_VARIABILE)); 
