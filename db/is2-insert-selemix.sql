...
-- PARAMETERS
-- 
INSERT INTO `is2_parameter` (`ID`, `NAME`, `DESCR`, `DEFAULT_VAL`, `JSON_TEMPLATE`)  VALUES (101,'MODEL','DATA MODEL',NULL,'{ "data": [], "schema": { "type": "array", "items": { "type": "object", "properties": { "layer": { "title": "Layer", "type": "string" }, "N": { "title": "N", "type": "number" }, "is.conv": { "title": "conv", "type": "boolean" }, "sing": { "title": "sing", "type": "boolean" }, "lambda": { "title": "lambda", "type": "number" }, "w": { "title": "w", "type": "number" }, "B": { "title": "B", "type": "string" }, "bic.aic": { "title": "bic.aic", "type": "string" }, "sigma": { "title": "sigma", "type": "number" } } } }, "options": { "type": "table", "showActionsColumn": false }}');
...
INSERT INTO `is2_app_role` (`ID`, `NAME`, `CODE`, `DESCR`, `ORDER_CODE`, `CLS_DATA_TYPE_ID`,`PARAMETER_ID`) VALUES (107,'ERRORE','E','ERRORE INFLUENTE',10,1,NULL);
...
INSERT INTO `is2_step_instance_signature` (`ID`, `STEP_INSTANCE_ID`, `APP_ROLE_ID`, `CLS_TYPE_IO_ID`, `REQUIRED`) VALUES (5,1,110,1,0);
